...
This repository contains a Tensorflow implementation of AlexNet optimized for the CIFAR-10 dataset.

## Features
- Optimized AlexNet architecture for $32 \times 32$ images.
- Trained on CIFAR-10.
